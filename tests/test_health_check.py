...
class TestHealthCheck(unittest.TestCase):
    ...
    def test_health_checker_check_service_health_success(self, mock_session):
        ...
        result = checker.check_service_health(
            'test_service', 
            health_check.SERVICES['test_service']
        )
    ...
    def test_main_success(self, mock_logger, mock_check_docker, mock_checker_class):
        ...
        # Check logger calls
        mock_logger.info.assert_any_call("🚀 Starting DynaDock service health checks...")
    ...
    @patch('health_check.logger')
    def test_main_service_down(self, mock_logger, mock_stop, mock_check_docker, mock_checker_class):
