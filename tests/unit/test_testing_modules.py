...
from src.dynadock.testing.browser_tester import cleanup_old_screenshots, setup_screenshots_dir
...
def run_all_tests():
    ...
    test_classes = [TestNetworkAnalyzer, TestSystemChecker, TestAutoRepair, TestBrowserTester]
